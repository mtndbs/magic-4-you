      ...
      <div className="container mx-auto px-4 md:px-8 grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="flex flex-col gap-6 order-2 md:order-1">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-lg">
            אנחנו תופסים את האנרגיה, החיוכים משתקפים, והפרטים הקטנים שעושים את
            האירוע שלכם לבלתי נשכח.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mt-4">
            ...
            <Button variant="outline">לצפייה בגלריה</Button>
          </div>
          ...
          <div className="flex items-center gap-4 mt-8 pt-6 border-t border-white/10">
            <div className="flex -space-x-3 -space-x-reverse">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-10 h-10 rounded-full bg-gray-600 border-2 border-dark overflow-hidden"
                >
                  <img
        ...
        <div className="order-1 md:order-2 flex flex-col items-center justify-center relative">
          ...
          <div className="text-center mt-8 space-y-2">
            <h2 className="text-6xl text-gold font-script drop-shadow-md">
              Magic 4 you
            </h2>
